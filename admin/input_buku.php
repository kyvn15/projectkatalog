...
<body>
    <div tabel>
        ...
        <form action="" enctype="multipart/form-data" method="POST">
            ...
            KATEGORI : <br>
            <label>
                <input type="radio" name="kategori" value="Fiksi" > FIKSI
                <input type="radio" name="kategori" value="Non-Fiksi" > NON-FIKSI
            </label><br><br>
            DESKRIPSI BUKU : <br> <input type="textarea" name="deskripsi" /> <br><br>
            PENERBIT : <br> <input type="text" name="penerbit" /> <br><br>
            PENGARANG : <br> <input type="text" name="pengarang" /> <br><br>
